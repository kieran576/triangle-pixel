...
\item \textbf{Geometric structure.} The lattice has 6-fold rotational symmetry (vs.\ 4-fold), providing near-isotropic response (2.1~dB anisotropy). Sierpinski self-similarity enables natural multi-scale pyramids. Triangular faces map directly to 3D mesh surfaces.
\end{enumerate}
