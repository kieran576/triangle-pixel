...
\textbf{Layer 2 (Borrow).} Each triangle fills all three color channels from its three neighbors, discarding its own measurement entirely (which exclusively contributes to adjacent triangles). By Property~2, all $\{R,G,B\}$ channels are available across the neighbors:
