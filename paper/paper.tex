...
We presented Triangle Pixel, a complete vision system replacing rectangular pixel grids with equilateral triangle meshes. The system spans sensor simulation through AI-native processing, demonstrating that triangular representations offer data efficiency (70\% of Bayer PSNR at 2\% of the samples, against a bilinear demosaicing baseline at lower spatial sampling density), geometric isotropy (2.1~dB directional variation), and a representation-level path to 3D surfaces, while enabling perceptually color-balanced raw preview and Sierpinski-based multi-scale processing at real-time speeds (59~FPS).
